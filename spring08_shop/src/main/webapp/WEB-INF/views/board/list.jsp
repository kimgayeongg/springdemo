...
<c:set var="contextPath" value="${pageCountext.request.contextPath}" />
<!-- /myapp 프로젝트 경로 리턴 -->
...
<div id="boardwrap">
	...
	<table class="table table-border mt-1">
		<tr>
			<th class="col-md-1 text-context">번호</th>
		...
		<c:forEach items="${aList}" var="dto">
			<tr>
				...
				<td class="pl-2 text-left"><c:url var="path" value="view.do">
						...
						<img src="../resource/images/level.gif" width="${20*dto.re_level}"
							height="15" />
	...
	<ul class="pagination justify-content-center mt-5 mb-5">
	  ...
	  <!-- 이전 출력 끝 -->
		...
		<li>
		<a class="page-link"href="list.do?currentPage=${pv.startPage + pv.blockPage}">Next</a></li>
		</c:if>
		<!-- 다음 출력 끝 -->
	</ul>
</div>
